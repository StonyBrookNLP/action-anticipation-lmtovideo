...
def get_map_to_action_class(fname):
    ...
    for action, action_row in df.iterrows():
        verb, noun = action_row[1].split('_')
        action_verb_noun_map[action_row[0]] = [int(verb), int(noun)]
...
if __name__ == "__main__":
    action_map = get_map_to_action_class('../egtea_verb_noun/actions.csv')
    preds_paths = ['/Users/tanviaggarwal/Desktop/SOP/model_results/egtea/baseline_preds.pickle']
