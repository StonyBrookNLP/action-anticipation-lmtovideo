...
def init_distributed_mode(logger, dist_backend='nccl'):
    ...
    print('custominfo: dist info gpu: ', dist_info['gpu'])  # custominfo
    print('custominfo: dist info: ', dist_info)  # custominfo
    # dist_info['gpu'] = 1  # custom
    # print('custominfo: dist info gpu 2: ', dist_info['gpu'])  # custominfo
    # print('custominfo: dist info 2: ', dist_info)  # custominfo
